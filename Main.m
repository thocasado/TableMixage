...
% dans notre cas
%Dans rapport metttre la sinusoide qui augmente a un moment donné , plot le
%signal !!!
...
%explication de la fonction randn... Tirage aléatoire de gaussienne prend
%en paramètre (ligne, Colonne). De base écart entre 3 et -3 ; si on veut
%changer les bornes on met un coeff devant randn
% RSB = Puissance signal/ puissance bruit = somme(échantillons^2)/somme(echantillons^2)
...
%Somme des échantillons du bruit^2 = a^2*somme des échantillons du buit de
%base (bruit de base c'est celui qu'on définit avec randn pour le bruit
%blanc par exemple).

% Pour calculer la somme de vecteur ligne au carré, on fait signal*transposée de signal 

% On doit ici aussi faire les plots des signaux bruités, on voit bien le
% bruit qui n'apparait pas forcemment facilement à l'oreille.
